...
CHECKOUT_DIR = "/home/selab/Desktop/MFRepair_ubuntu/resources/checkout"

def main():
    with open ("/home/selab/Desktop/MFRepair_ubuntu/resources/validation_data.json", "r") as file:
        data=json.load(file)
    for bug_id in data:
